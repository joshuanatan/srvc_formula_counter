<div class = "col-lg-12">
    <button type = "button" class = "btn btn-primary btn-sm" data-toggle = "modal" data-target = "#addAttribute" style = "margin-right:10px">Tambah Alat</button>
        ...
        <div class = "modal-content">
            ...
            <div class = "modal-body">
                <form id = "register_form" method = "POST">
                    <input type = "hidden" name = "attr_type" value = "ALAT">
                    <div class = "form-group">
                        <h5>Nama Alat</h5>
...
<div class = "modal fade" id = "editAttribute">
    <div class = "modal-dialog">
        <div class = "modal-content">
            <div class = "modal-header">
                <h4 class = "modal-title">Ubah Data Alat</h4>
            </div>
            <div class = "modal-body">
    ...
    <div class = "modal-dialog">
        <div class = "modal-content">
            ...
            <input type = "hidden" name = "attr_id" value = "" id = "attr_id_delete">
                <h4 align = "center">Apakah anda yakin akan menghapus data alat di bawah ini?</h4>
